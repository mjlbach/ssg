#!/bin/bash           
#
#SBATCH --job-name=hgt_learned_attention_goal_embedding_paper_seed_0
...
python scripts/train.py ++experiment_name=$SLURM_JOB_NAME ++seed=0 +experiment=neurips/exploratory_search_paper/hgt_learned_attention_goal_embedding
