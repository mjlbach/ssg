#!/bin/bash           
#
#SBATCH --job-name=mcm_premap_single_scene_seed_0
...
python scripts/train.py ++experiment_name=$SLURM_JOB_NAME ++seed=0 +experiment=neurips/exploratory_search_single_scene/mcm_premap
