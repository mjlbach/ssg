#!/bin/bash           
#
#SBATCH --job-name=hgt_learned_attention_limited_single_scene_seed_0
...
python scripts/train.py ++experiment_name=$SLURM_JOB_NAME ++seed=0 +experiment=neurips/exploratory_search_single_scene/hgt_learned_attention_limited
