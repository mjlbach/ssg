#!/bin/bash           
#
#SBATCH --job-name=hgt_learned_attention_limited_seed_0
...
python scripts/train.py ++experiment_name=$SLURM_JOB_NAME ++seed=0 +experiment=neurips/exploratory_search/hgt_learned_attention_limited
