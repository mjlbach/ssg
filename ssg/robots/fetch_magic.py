...
class FetchMagic(TwoWheelRobot, ActiveCameraRobot):
    """
    Fetch Robot
    ...
    def apply_action(self, action):
        ...
        #             if (
        #                 np.linalg.norm(
        #                     np.array((robot_pos[0], robot_pos[1])) - np.array((x, y))
        #                 )
        #                 > 1.0
        #             ):
        #                 continue
        ...
        #     obj_list = sorted(
        #         obj_list,
        #         key=lambda x: np.linalg.norm(x.get_position() - self.get_position()),
        #     )
        #     if len(obj_list) > 0:
        #         obj = obj_list[0]
        #         self.inventory.states[igibson.object_states.OnTop].set_value(
